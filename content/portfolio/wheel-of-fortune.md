...
screenshots:
  - images/portfolio/wheel-store-1.png
  - images/portfolio/wheel-store-2.png
...
- `Solitario` (single player)
- `Sfida Amici` (local multiplayer on the same device)
- `Contro il Computer` (play versus bot opponents)
